...
$dateArray = __c()->get("chartRUSH30Date");
$minArray  = __c()->get("chartRUSH30Min");
$cached = true;
...
if ($dateArray == null || $minArray == null) {
	...
	//we actually have to select 31 rows and not 30
    $getAll = "(SELECT * FROM " . $conRUSHDB . "." . $conRUSHTable . " ORDER BY id DESC LIMIT 31) ORDER BY id ASC;";
	...
	//Insert into cache
    __c()->set("chartRUSH30Date", $dateArray, 600);
    __c()->set("chartRUSH30Min", $minArray, 600);
	$cached = false;
}
